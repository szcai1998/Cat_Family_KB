...
For each species the atlas expects a “hero poster” — a striking visual summarising the animal’s appearance and identity. This poster might combine a photograph or illustration with key facts such as the species’ name, biome and an evocative tagline. In the species profile you will see a placeholder for the hero poster (e.g. `![](../04_Visual_Production/Hero_Posters/01_siberian_tiger_amur_tiger.png)`). Replace the placeholder file with your own image when you create the visual asset.
