...
│   ├── Panthera
│   │   ├── Tiger (*Panthera tigris*) – including the Siberian/Amur tiger
│   │   ├── Lion (*Panthera leo*)
│   │   ├── Jaguar (*Panthera onca*)
│   │   ├── Leopard (*Panthera pardus*) – African leopard subspecies
...
└── Felinae (small & medium cats)
    ...
    │   └── Cheetah (*Acinonyx jubatus*) – historically placed in its own subfamily but now classified within Felinae
    ├── Lynx lineage
